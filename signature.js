// signature.js — Email signature (pure inline HTML, compatible with all email clients)
// No external CSS, no data: URIs, no @font-face — all inline styles in <table> layout

function getEmailSignature() {
  return (
    '<table cellpadding="0" cellspacing="0" border="0" style="border-top:2px solid #000;padding-top:16px;margin-top:32px;font-family:Helvetica,Arial,sans-serif;">' +
    '<tr><td style="padding-bottom:12px;">' +
      '<strong style="font-size:15px;letter-spacing:0.04em;text-transform:uppercase;">FREDERICO E. REICHEL</strong><br/>' +
      '<span style="font-size:12px;letter-spacing:0.06em;text-transform:uppercase;color:#555;">Rechtsanwalt</span>' +
    '</td></tr>' +
    '<tr><td style="border-top:1px solid #ccc;padding-top:10px;font-size:11.5px;color:#222;line-height:1.7;">' +
      ...
      '<span style="display:inline-block;width:28px;color:#555;font-size:10.5px;">WA</span> +49 155 60245902' +
    '</td></tr>' +
