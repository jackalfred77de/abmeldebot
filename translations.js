...
const translations = {
  de: {
    ...
    ask_delivery_method: '📬 Wie möchten Sie Ihre **Abmeldebestätigung** erhalten?',
    delivery_email_btn: '📧 Per E-Mail (inklusive)',
    delivery_post_btn: '📮 Per Post (+€15 Bearbeitung + Versandkosten)',
    ask_postal_address: '📮 An welche Adresse sollen wir die Bestätigung senden?',
    use_new_address_btn: '📬 Neue Adresse verwenden',
    other_address_btn: '📝 Andere Adresse',
    delivery_post_confirmation: '📮 Postversand an: {address}\n💰 Bearbeitungsgebühr: €15,00\n💡 Versandkosten werden je nach Zielland berechnet und separat mitgeteilt.',
    delivery_email_label: '📧 Per E-Mail (inklusive)',
    delivery_post_label: '📮 Per Post — €15,00 Bearbeitung + Versandkosten je nach Zielland',
    total_price_label: '💰 Gesamtpreis: €{total} (zzgl. Versandkosten)',
  ...
  pt: {
    ...
    ask_delivery_method: '📬 Como deseja receber a sua **Abmeldebestätigung** (confirmação)?',
    delivery_email_btn: '📧 Por e-mail (incluído)',
    delivery_post_btn: '📮 Por correio (+€15 processamento + custos de envio)',
    ...
    delivery_post_confirmation: '📮 Envio por correio para: {address}\n💰 Taxa de processamento: €15,00\n💡 Custos de envio serão calculados conforme o país de destino e informados separadamente.',
    delivery_email_label: '📧 Por e-mail (incluído)',
    delivery_post_label: '📮 Por correio — €15,00 processamento + custos de envio conforme destino',
    total_price_label: '💰 Preço total: €{total} (+ custos de envio)',
  ...
  en: {
    ...
    ask_delivery_method: '📬 How would you like to receive your **Abmeldebestätigung** (confirmation)?',
    delivery_email_btn: '📧 By email (included)',
    delivery_post_btn: '📮 By post (+€15 processing + shipping costs)',
    ask_postal_address: '📮 To which address should we send the confirmation?',
    use_new_address_btn: '📬 Use new address',
    other_address_btn: '📝 Other address',
    delivery_post_confirmation: '📮 Postal delivery to: {address}\n💰 Processing fee: €15.00\n💡 Shipping costs will be calculated based on destination country and communicated separately.',
    delivery_email_label: '📧 By email (included)',
    delivery_post_label: '📮 By post — €15.00 processing + shipping based on destination',
    total_price_label: '💰 Total price: €{total} (+ shipping costs)',
